    ...
    <div class="jumbotron">
        <form method="POST" action="http://localhost/sistema2022/public/docentes/actualizar">
            <div class="form-group row">
                <label for="iddocente" class="col-4 col-form-label">Id Aumno</label> 
                <div class="col-8">
                <div class="input-group">
                    ...
                    <input id="iddocente" name="iddocente" type="text" class="form-control" value="<?=$datos['iddocente']?>" readonly>
                </div>
                </div>
            </div>
            <div class="form-group row">
